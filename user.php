                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>User_ID</label>
                                                <input type="text" class="form-control" disabled value="<?php echo $_SESSION['user_id']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="author">
                                    ...
                                    <img class="avatar border-gray" src="assets/img/faces/face-3.jpg" alt="..."/>
                                      ...
                                      <h4 class="title"><?php echo $_SESSION['fname'].' '.$_SESSION['lname']; ?> <br />
                                         <small><?php echo "User_ID:".' '.$_SESSION['user_id']; ?></small>
                                      </h4>
                                    </a>
                                </div>
                                <p class="description text-center"> <?php echo "email:".' '.$_SESSION['email']; ?>
                                <br>
                                <button type="submit" name="delete" style="background-color: #FF0022; padding: 15px 32px; font-size: 16px; border-color:#FF0022">Delete Profile</button>
                                </p>
